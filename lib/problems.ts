...
export const problems: Problem[] = [
  ...
  },
  {
    ...
    data: {
      ...
      rows: [
        ...
        {
          cells: ['how to fix leaky tap diy', '312', '$1,560', '0'],
          highlight: true,
        },
        {
          cells: ['plumber salary australia', '89', '$445', '0'],
          highlight: true,
        },
        {
          cells: ['plumbing memes funny', '67', '$335', '0'],
          highlight: true,
        },
        { cells: ['blocked drain specialist', '234', '$1,404', '19'] },
        {
          cells: ['is plumbing hard to learn', '45', '$225', '0'],
          highlight: true,
        },
  ...
  },
  {
    id: 3,
    icon: '\u{1F4A8}',
    title: 'Great meeting. Nobody acted on it.',
    subtitle: '42 minutes of gold. Zero paper trail.',
    paths: ['business'],
  ...
  },
  {
    ...
    subtitle:
      "There's a client escalation buried in there. Somewhere.",
    paths: ['business'],
  ...
  },
  {
    ...
    data: {
      ...
      rows: [
        {
          cells: ['Sarah Mitchell', 'Bright Sparks', 'Dec 2024', 'Onboarded'],
          highlight: true,
        },
        {
          cells: ['Marcus Lee', 'Lee & Partners', 'Oct 2024', 'Active'],
          highlight: true,
        },
        {
        ...
        {
          cells: ['Priya Sharma', 'GreenLeaf Co', 'Nov 2024', 'At Risk'],
          highlight: true,
        },
  ...
  },
  {
    ...
    data: {
      ...
      rows: [
        ...
        {
          cells: ['Google - Generic', '$8,200', '34', '$241', '\u2193 8%'],
          highlight: true,
        },
        {
          cells: [
  ...
  },
  {
    ...
    data: {
      ...
      rows: [
        ...
        {
          cells: ['Jun 2025', '$79,000', '$76,000', '$3,000', '3.8%'],
          highlight: true,
        },
  ...
  },
  {
    ...
    data: {
      ...
      rows: [
        {
          cells: ['Their ads look different', 'New headlines this week?'],
          highlight: true,
        },
        {
          cells: ['New promotion running', 'Since when? What offer?'],
          highlight: true,
        },
        {
        ...
        {
          cells: ['Client asked about it', 'You found out second'],
          highlight: true,
        },
        {
          cells: ['Last competitor check', "Can't remember"],
          muted: true,
        },
      ],
    },
  },
  {
    id: 10,
    icon: '\u{1F195}',
    title: 'New hire starts Monday. No plan exists.',
    subtitle: 'The process lives in your head and scattered notes',
    paths: ['business'],
    ...
    tryThis:
      "Turn these messy onboarding notes into a structured 2-week onboarding plan with daily tasks, a checklist, and a welcome email for the new starter.",
    data: {
      type: 'text',
  ...
  },
  {
    ...
    tryThis:
      'Summarise this newsletter for me. Note anything unusual or suspicious in the content.',
    data: {
      type: 'text',
  ...
  },
  {
    ...
    tryThis:
      "Draft me a 2-minute explanation of how our agency uses AI for client delivery. Make it concrete \u2014 specific examples, not buzzwords. Something I can say on the next client call.",
    data: {
      type: 'table',
      ...
      rows: [
        ...
        {
          cells: ['You:', '"Great question. Let me show you."'],
          highlight: true,
        },
        { cells: ['', ''] },
        {
        ...
        {
          cells: ['What you need:', 'This \u2014 right here, right now'],
          muted: true,
        },
      ],
    },
