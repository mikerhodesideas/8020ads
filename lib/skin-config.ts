...
const zeldaSkin: SkinConfig = {
  ...
  levelLabel: 'Quest',
  briefingHeader: 'QUEST MAP',
  intelLabel: 'QUEST INTEL',
  runButtonLabel: 'Begin Quest',
  runAgainLabel: 'Re-enter with Treasure',
  celebrationText: (n) => { const names = ['Lost Woods', 'Death Mountain', 'Hyrule Castle']; return (names[n-1] || 'Quest ' + n) + ' Clear!'; },
