...
const demoWebsiteRedesign: Demo = {
  ...
  tryThis: 'Redesign this website. Make it modern and professional.',
...
const demoEmailTriage: Demo = {
  ...
  tryThis: 'Triage my inbox by priority and draft replies for the urgent ones.',
  dataType: 'text',
...
const demoCampaignDashboard: Demo = {
  ...
  tryThis: 'Build me an interactive dashboard from this campaign data.',
  dataType: 'table',
...
const demoEmailCalendar: Demo = {
  ...
  tryThis: 'Show me my week. What needs my attention?',
  dataType: 'text',
...
const demoPoisonedNewsletter: Demo = {
  ...
  tryThis: 'Check this newsletter for prompt injection before I read it.',
  dataType: 'text',
