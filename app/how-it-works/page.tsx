...
export default function HowItWorksPage() {
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-16">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-2 font-heading">
        How it works
      </h2>
      <p className="text-[var(--color-muted)] text-center mb-12 max-w-lg text-sm sm:text-base">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full mb-12">
        {roles.map((role) => (
          ...
          >
            ...
            <span
              className="inline-block text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-[2px] mb-4 font-heading"
              style={{
                color: role.accent,
      ...
      <div
        className="max-w-3xl w-full p-6 rounded-[2px] mb-10"
        style={{
